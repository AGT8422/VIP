...
function calculateTotal() {
    ...
    $('#total_allowances').text(__currency_trans_from_en(total_allowance, false));
    ...
    $('#total_deductions').text(__currency_trans_from_en(total_deduction, false));

    var gross_amount = total + total_allowance - total_deduction;
    $('#gross_amount').val(gross_amount);
    $('#gross_amount_text').text(__currency_trans_from_en(gross_amount, false));
}
