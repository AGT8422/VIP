		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					{!! Form::select('store_id', $stores, $store_out, ['class' => 'form-control hide','required','id'=>'store_id']); !!}
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					@show_tooltip(__('tooltip.purchase_location'))
					<input name="location_id" type="hidden" value="{{array_keys($business_locations->toArray())[0]}}" id="location_id">
					{!! Form::select('store_in', $stores,isset(array_keys($stores)[0])?array_keys($stores)[0]:0, ['class' => 'form-control ','id'=>'store_in','required']); !!}
				</div>
			</div>
			@if($store_out != null )
			<div class="col-sm-3">
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('manufacturing::lang.ingredients')])
		...
		<div class="row">
			<div class="col-md-3 col-md-offset-9">
				...
				<input type="hidden"  id="total_production_cost_"  value="0"/> <br>
				<strong>
