...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('partner.Final_Account')</h1>
    </section>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-3">
                                <div class="form-group">
                                    {!! Form::label('startdate',__('partner.About_the_duration_of')  .':') !!}
                                    {!! Form::text('startdate', null, ['class' => 'form-control startdate', 'required', 'placeholder' =>__('partner.Start_of_the_term') ]); !!}
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-3">
                                <div class="form-group">
                                    {!! Form::label('enddate',__('partner.to').':') !!}
                                    {!! Form::text('enddate', null, ['class' => 'form-control enddate', 'required', 'placeholder' =>__('partner.End_of_term') ]); !!}
                                </div>
                            </div>
                        </div>
            ...
            @can('assets.view')
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped " >
                            <thead>
                            <tr>
                                <th>@lang('partner.Value_of_profits')</th>
                                <th>@lang('partner.Period_from')</th>
                                <th>@lang('partner.to')</th>
                                <th>@lang('partner.numberOfShares')</th>
                                <th>@lang('partner.value_of_share')</th>
                ...
                <hr>
                <h3>@lang('partner.Partner_Accounts')</h3>
                <div class="table-responsive" >
                    <table class="table table-bordered table-striped " >
                        <thead>
                        <tr>
