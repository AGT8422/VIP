                        ...
                        <div class="box-body">
                            ...
                            <table class="table no-border product-info-table">
                                <tr>
                                    ...
                                    <td class="pb-0">
                                        <span class="display_currency" data-currency_symbol="true">{{@num_format($max_price)}}</span> @if($max_price != $min_price) - <span class="display_currency" data-currency_symbol="true">{{@num_format($min_price)}}</span> @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @foreach($product_variation as $variation)
                                                <option value="{{$variation->id}}">{{$variation->name}} ({{$variation->sub_sku}}) - {{@num_format($variation->sell_price_inc_tax)}}</option>
                                            @endforeach
                                            </select>
                                        </td>
                                    </tr>
