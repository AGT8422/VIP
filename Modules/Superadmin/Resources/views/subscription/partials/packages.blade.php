		...
		<div class="box box-success hvr-grow-shadow">
			...
			<div class="box-body text-center">
				...
				@if($package->trial_days != 0)
					<i class="fa fa-check text-success"></i>
					 @lang('superadmin::lang.trial_days') : {{$package->trial_days}}    @lang('superadmin::lang.days')
					<br/><br/>
				@endif
				...
				<h3 class="text-center">
					...
					@else
						@lang('superadmin::lang.free_for_duration') : {{$package->interval_count }} {{$interval_type}}
					@endif
				</h3>
			</div>
			<!-- /.box-body -->
