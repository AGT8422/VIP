@extends('layouts.app')
@section('title', __('woocommerce::lang.bill'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('woocommerce::lang.bill')</h1>
</section>
...
<section class="content">
     <div class="row">
        <div class="col-xs-12" style="padding:10px;  max-height:auto; ">
            ...
            {{-- *********3************ --}}
            @component('components.widget',['class'=>' sections box-primary',"title"=>__('All Bill')]) 
            <div class="tab">
                <div class="row">
                    {{-- <div class="col-lg-12 ">
                ...
                <div class="content" style="width:100%">
                    <table class="table table-striped table-bordered dataTable" style="width:100%" id="table_bill">
                        <thead>
                            <tr>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            table_bill = $('#table_bill').DataTable({
                processing:     true,
                serverSide:     true,
                // scrollY:        "75vh",
                // scrollX:        true,
                ...
                fnDrawCallback: function(oSettings) {
                    __currency_convert_recursively($('#table_bill'));
                },
            });
        });
