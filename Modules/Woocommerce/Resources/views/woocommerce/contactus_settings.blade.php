@extends('layouts.app')
@section('title', __('woocommerce::lang.contactus_settings'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('woocommerce::lang.contactus_settings')</h1>
</section>

<!-- Main content -->
<section class="content">
    {!! Form::open(['action' => '\Modules\Woocommerce\Http\Controllers\WoocommerceController@updateContactUsSettings', 'method' => 'post','files' => true]) !!}
    <div class="row">
        <div class="col-xs-12" style="padding:10px;  max-height:auto; ">
           <!--  <pos-tab-container> -->
            ...
            {{-- *********3************ --}}
            @component('components.widget',['class'=>' sections box-primary',"title"=>__('All Contact Us')]) 
            <div class="tab">
                <div class="row">
                    <div class="col-lg-12 ">
                        <a class="btn btn-primary pull-right" href="{{action("\Modules\Woocommerce\Http\Controllers\WoocommerceController@createContact" , ['style'=>'about'])}}">@lang('messages.add') <i class="fa fas-fa fa-plus"></i></a>
                    </div>
                </div>
                <div class="content" style="width:100%">
                    <table class="table table-striped table-bordered dataTable" style="width:100%" id="table_contact_us">
                        <thead>
                            <tr>
                                ...
                                <th class="xl-2 desc_section"  style="background-color:#00000034;width:150px">Links</th>
                                <th class="xl-1 btn_section"  style="background-color:#00000034">Address</th>
                                <th class="xl-1 btn_section"  style="background-color:#00000034">Additional Info</th>
            ...
            @endcomponent
            {{-- *********4************ --}}
            @component('components.widget',['class'=>' sections box-primary',"title"=>__('All Social Media')]) 
            <div class="tab">
                <div class="row">
                    <div class="col-lg-12 ">
                        <a class="btn btn-primary pull-right" href="{{action("\Modules\Woocommerce\Http\Controllers\WoocommerceController@createSocial" , ['style'=>'about'])}}">@lang('messages.add') <i class="fa fas-fa fa-plus"></i></a>
                    </div>
                </div>
                <div class="content" style="width:100%">
                    <table class="table table-striped table-bordered dataTable" style="width:100%" id="table_social">
                        <thead>
                            <tr>
                                <th class="xl-1"  style="background-color:#00000034">Action</th>
                                <th class="xl-1 img_section"  style="background-color:#00000034">Icon</th>
                                <th class="xl-1"  style="background-color:#00000034">Title</th>
                                <th class="xl-1"  style="background-color:#00000034">Link</th>
                                <th class="xl-1"  style="background-color:#00000034">Type</th>
                            </tr>
                        </thead>
                        <tbody>
...
<script type="text/javascript">
        ...
        table_social = $('#table_social').DataTable({
            processing:true,
            serverSide:true,
            scrollY:  "75vh",
            scrollX:  true,
            ...
            fnDrawCallback: function(oSettings) {
                __currency_convert_recursively($('#table_social'));
            },
        });
