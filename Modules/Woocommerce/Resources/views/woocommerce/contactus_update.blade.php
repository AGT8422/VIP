@extends('layouts.app')
@section('title', __('woocommerce::lang.contactus_edit'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('woocommerce::lang.contactus_edit')</h1>
</section>

<!-- Main content -->
<section class="content">
    {!! Form::open(['action' => ['\Modules\Woocommerce\Http\Controllers\WoocommerceController@updateContact' ,"id"=>$id], 'method' => 'post','files' => true]) !!}
    <div class="row">
        <div class="col-xs-12" style="padding:10px;  max-height:auto;margin:auto 30% ;width:40% ">
            ...
            <div class="row">
                    <div class="col-lg-12 col-md-12  col-sm-12 col-xs-12">
                                {!! Form::text('title', ($contact)?$contact->title:null, ['class' => 'form-control',"placeholder"=>__("messages.please_enter_title"),"style"=>"max-width:100%;font-size:20px !important;font-weight:bold !important"]); !!}
                                <br>  
                                {!! Form::text('links', ($contact)?$contact->links:null, ['class' => 'form-control hide',"placeholder"=>__("Link"),"style"=>"max-width:100%"]); !!}  
                                <br>
                                {!! Form::text('mobile', ($contact)?$contact->mobile:null, ['class' => 'form-control',"placeholder"=>__("messages.enter_mobile"),"style"=>"max-width:100%"]); !!}  
                                <br>
                                {!! Form::text('address', ($contact)?$contact->address:null, ['class' => 'form-control hide',"placeholder"=>__("Address"),"style"=>"max-width:100%"]); !!}
                                <br>
                                {!! Form::text('additional_info', ($contact)?$contact->additional_info:null, ['class' => 'form-control hide',"id"=>"additional_info","style"=>"max-width:100%","placeholder"=>__("Additional Note")]); !!}                                 
                    </div>
                    <div class="col-lg-12 col-md-12  col-sm-12 col-xs-12">
                        ...
                        <br>
                        @if($contact->icon_url != null || $contact->icon_url != "" )
                            <div class="col-lg-12 text-center">
                                <img src="{{$contact->icon_url}}" width=80% height=20% style="border-radius:10px;border:2px solid black;padding: 2px" />
                            </div>
                        @endif
                    </div>
            </div>
