@extends('layouts.app')
@section('title', __('woocommerce::lang.floating_create'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('woocommerce::lang.floating_create')</h1>
</section>
...
<section class="content">
    {!! Form::open(['action' => '\Modules\Woocommerce\Http\Controllers\WoocommerceController@saveFloat', 'method' => 'post','files' => true]) !!}
    <div class="row">
