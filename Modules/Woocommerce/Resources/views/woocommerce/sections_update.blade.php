...
<section class="content">
    {!! Form::open(['action' => ['\Modules\Woocommerce\Http\Controllers\WoocommerceController@updateSections',"id"=>$id], 'method' => 'post','files' => true]) !!}
    <div class="row">
             ...
             @component('components.widget',['class'=>'  sections  ']) 
                <div class="contents">
                    <div class="col-xs-12" style="padding:20px !important;"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><div class="leftSection sec   form-group" style="padding:10px;">
                        {!! Form::text("name" , ($section)?$section->name:null, ['class' => 'form-control' ,'required','placeholder'=>__('messages.name_section')."*",'style'=>'max-width:50%;font-size:20px !important;font-weight:bold !important']); !!}
                        {!! Form::text("title", ($section)?$section->title:null, ['class' => 'form-control','placeholder'=>__('messages.please_enter_title'),'style'=>'max-width:50%']); !!}
                        <br>
                        {!! Form::textarea("description",($section)?$section->desc:null, ['class' => 'form-control','id'=>'description','placeholder'=>__('messages.please_enter_desc')]); !!}
                        <br>
                        {!! Form::text("button", ($section)?$section->button:null, ['class' => 'form-control','placeholder'=>__('messages.please_enter_btn_desc'),'style'=>'max-width:50%']); !!}
                        <br>
                        {!! Form::number("index_item" , ($section)?$section->index_item:null, ['class' => 'form-control','min'=>0 ,'required','placeholder'=>__('Index')." ",'style'=>'max-width:50%;font-size:10px !important;font-weight:bold !important']); !!}
                        <br>
                        ...
                        <small><p class="help-block">@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]) <br> @lang('lang_v1.aspect_ratio_should_be_1_1')</p></small></div></div>
                            <br>
                        @if($section->image_url != null || $section->image_url != "" )
                            <div class="col-lg-6 text-center">
                                <img src="{{$section->image_url}}" width=80% height=20% style="border-radius:10px;border:2px solid black;padding: 2px" />
                            </div>
                        @endif
                    </div> 
