...
Route::group(['middleware' => ['web', 'SetSessionData',  'language', 'timezone', 'AdminSidebarMenu' , 'superadmin'], 'prefix' => 'woocommerce', 'namespace' => 'Modules\Woocommerce\Http\Controllers'], function () {
