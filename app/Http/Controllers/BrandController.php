...
class BrandController extends Controller
{
    ...
    public function create1()
    {
        ...
        $parent_categories = ["please select"];
        if (!empty($categories)) {
        ...
        return view('brand.category')
                ->with(compact('parent_categories','category_type','module_category_data','quick_add', 'is_repair_installed'));
    }
