...
class CheckController extends Controller
{
    ...
    public function __construct(ModuleUtil $moduleUtil, ProductUtil $productUtil,Util $commonUtil,TransactionUtil $transactionUtil)
    {
            ...
            foreach ($request->file('document_expense') as $file) {
                ...
                if(!in_array($file->getClientOriginalExtension(),["jpg","png","jpeg"])){
                    ...
                    if ($file->getSize() <= config('constants.document_size_limit')) {
                        ...
                        // }
                        $public_path = public_path('uploads/companies/'.$company_name.'/documents/check');
