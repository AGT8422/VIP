...
class InvoiceLayoutController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('invoice_layout.create')->with(compact('designs', 'terms' , 'is_warranty_enabled','invoice_layout'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only(['name',  'header_text','purchase_text','purchase_footer','invoice_text',
                'invoice_no_prefix', 'invoice_heading', 'sub_total_label', 'discount_label', 'tax_label', 'total_label', 'highlight_color', 'footer_text', 'invoice_heading_not_paid', 'invoice_heading_paid', 'total_due_label', 'customer_label', 'paid_label', 'sub_heading_line1', 'sub_heading_line2',
                    ...
                    'table_product_label', 'table_qty_label', 'table_unit_price_label',"delivery_text","quotation_terms",
    ...
    public function edit($id)
    {
        ...
        return view('invoice_layout.edit')
                ->with(compact('invoice_layout','terms', 'designs'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'header_text','purchase_text','purchase_footer','invoice_text',
                    'invoice_no_prefix', 'invoice_heading', 'sub_total_label', 'discount_label', 'tax_label', 'total_label', 'highlight_color', 'footer_text', 'invoice_heading_not_paid', 'invoice_heading_paid', 'total_due_label', 'customer_label', 'paid_label', 'sub_heading_line1', 'sub_heading_line2',
                    'sub_heading_line3', 'sub_heading_line4', 'sub_heading_line5',
                    'table_product_label', 'table_qty_label', 'table_unit_price_label',"delivery_text",
                    ...
                    ,'tax_number','tax_number2','commercial_register','quotation_terms'
                           ]);
            $business_id = $request->session()->get('user.business_id');
            ...
            $input['quotation_terms']       =  $request->input('quotation_terms');
