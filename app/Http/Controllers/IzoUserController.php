    ...
    public function createCompany(Request $request)
    {
        ...
        try{
            ...
            $permissions = [
                ...
                153 => "customer.view",
                154 => "customer.view_own",
                155 => "customer.create",
                156 => "customer.update",
                // 157 => "customer.delete",

                158 => "product.view",
                159 => "product.view_sStock",
                160 => "product.avarage_cost",
                161 => "product.create",
                162 => "product.update", 
                // 163 => "product.delete",
                // 167 => "delete_product_image",

                164 => "product.opening_stock",
                165 => "stcok_compares",
                166 => "view_purchase_price",

                168 => "purchase.view",
                169 => "purchase.porduct_qty_setting",
                170 => "purchase.create",
                171 => "purchase.edit_composeit_discount",
                172 => "purchase.update",
                177 => "purchase.update_status",
                174 => "purchase.payments",
                // 174 => "purchase.received",#....
                // 173 => "purchase.delete",
                
                175 => "purchase_payment.edit",
                // 176 => "purchase_payment.delete",
                178 => "view_own_purchase",
                179 => "purchase_return.view",
                180 => "purchase_return.create",

                181 => "stock_transfer",
                182 => "stock_transfer.create_pending",
                183 => "stock_transfer.create_confirmed",
                184 => "stock_transfer.create_in_transit",
                185 => "stock_transfer.create_completed",
                186 => "stocktacking.view",
                187 => "stocktacking.show_qty_available",
                188 => "stocktacking.create",
                189 => "stocktacking.changeStatus",
                190 => "stocktacking.products",
                191 => "stocktacking.delete_form_stocktacking",
                192 => "stocktacking.report",
                193 => "stocktacking.liquidation",

                194 => "sales.print_invoice",
                195 => "sales.pos_meswada",
                196 => "sales.edit_composite_discount",
                197 => "sales.price_offer",
                198 => "sales.puse_sell",
                199 => "sales.puse_show",
                200 => "sales.sell_agel",
                201 => "sales.pay_card",
                202 => "sales.multi_pay_ways",
                203 => "sales.sell_in_cash",
                204 => "sales.less_than_purchase_price",
                205 => "sales.show",
                206 => "sales.show_current_stock_in_pos",
                207 => "sales.show_purchase_price_in_pos",
                208 => "today_sells_total.show",
                
                209 => "sell.view",
                210 => "sell.installment",
                211 => "sell.create",
                212 => "sell.can_edit",
                213 => "sell.update",
                215 => "direct_sell.access",
                // 213 => "sell.delivered",#....
                // 214 => "sell.delete",

                216 => "list_drafts",
                217 => "list_quotations",
                218 => "view_own_sell_only",

                219 => "sell.payments",
                220 => "sell_payment.edit",
                // 221 => "sell_payment.delete",
                222 => "edit_product_price_from_sale_screen",
                223 => "edit_product_price_from_pos_screen",
                224 => "edit_product_discount_from_sale_screen",
                225 => "edit_product_discount_from_pos_screen",
                226 => "access_types_of_service",
                227 => "access_sell_return",
                228 => "importsales.create",
                229 => "recent_transaction.view",
                230 => "customer_balance_due_in_pos",
                231 => "pos_lite",
                232 => "pos_repair",
                233 => "all_sales_prices",
                234 => "expenses.view",
                235 => "expense.categories",
                236 => "expense.create",
                237 => "expense.edit",
                // 238 => "expense.delete",
                239 => "view_cash_register",
                240 => "close_cash_register",
                241 => "register_payment_details.view",
                242 => "register_product_details.view",
                243 => "brand.view",
                244 => "brand.create",
                245 => "brand.update",
                // 246 => "brand.delete",
                ...
                257 => "category.update",
                // 258 => "category.delete",
                259 => "purchase_n_sell_report.view",
                260 => "tax_report.view",
                261 => "contacts_report.view",
                262 => "profit_loss_report.view",
                263 => "stock_report.view",
                264 => "stock_missing_report.view",
                265 => "trending_product_report.view",
                266 => "register_report.view",
                267 => "sales_representative.view",
                268 => "view_product_stock_value",
                269 => "less_trending_product_report.view",
                270 => "sell_purchase_lines_report.view",
                271 => "business_settings.backup_database",
                272 => "business_settings.access",
                273 => "barcode_settings.access",
                274 => "invoice_settings.access",
                275 => "access_printers",
                276 => "account.access",
                277 => "contact_bank.view",
                278 => "contact_bank.create",
                279 => "contact_bank.update",
                // 280 => "contact_bank.delete",
                281 => "cheque.view",
                282 => "cheque.create",
                283 => "cheque.update",
                // 284 => "cheque.delete",
                285 => "payment_voucher.view",
                286 => "payment_voucher.create",
                287 => "payment_voucher.update",
                // 288 => "payment_voucher.delete",
                289 => "daily_payment.view",
                290 => "daily_payment.create",
                291 => "daily_payment.update",
                // 292 => "daily_payment.delete",
                293 => "gournal_voucher.view",
                294 => "gournal_voucher.create",
                295 => "gournal_voucher.update",
                // 296 => "gournal_voucher.delete",
                297 => "warehouse.view",
                298 => "warehouse.movement",
                299 => "warehouse.create",
                300 => "warehouse.update",
                // 301 => "warehouse.delete",
                302 => "warehouse.recieved",
                303 => "warehouse.add_recieved",
                304 => "warehouse.delivered",
                305 => "warehouse.add_delivered",
                306 => "warehouse.invetory",
                307 => "warehouse.add_invetory",
                308 => "warehouse.adjustment",
                309 => "warehouse.add_adjustment",
                310 => "account.view",
                311 => "account.create",
                312 => "account.update",
                313 => "account.balance_sheet",
                314 => "account.trial_balance",
                315 => "account.cash_flow",
                316 => "account.payment_account_report",
                317 => "account.cost_center",
                // 312 => "account.close_account",
                318 => "account.add_cost_center",
                319 => "manufacturing.access_recipe",
                320 => "manufacturing.add_recipe",
                321 => "manufacturing.edit_recipe",
                // 319 => "manufacturing.delete_recipe",
                322 => "manufacturing.access_production",
