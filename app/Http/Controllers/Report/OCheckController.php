...
class OCheckController extends Controller
{
    public function index($id,Request $request)
    {
        ...
        if ($invoice) {
            ...
            $pdf = PDF::loadView('pdf.Check.Cheque_out', $arr);
             
            return $pdf->stream('Cheque_in.pdf');
        }else {
           return '<h1> Sorry This Cheque In Not Found </h1>'; 
        }
