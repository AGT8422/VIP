...
class SellReturnController extends Controller
{
     ...
     * @return void
     */
    public function __construct(ProductUtil $productUtil, Util $commonUtil, TransactionUtil $transactionUtil, ContactUtil $contactUtil, BusinessUtil $businessUtil, ModuleUtil $moduleUtil)
    {
                    ...
                    foreach ($request->file('document_sell') as $file) {
                        ...
                        if(!in_array($file->getClientOriginalExtension(),["jpg","png","jpeg"])){
                            ...
                            if ($file->getSize() <= config('constants.document_size_limit')) {
                                ...
                                // }
                                $public_path = public_path('uploads/companies/'.$company_name.'/documents/sale_return');
