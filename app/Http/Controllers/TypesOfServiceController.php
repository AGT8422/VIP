...
class TypesOfServiceController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Util $commonUtil ,ContactUtil $contactUtil, BusinessUtil $businessUtil, TransactionUtil $transactionUtil, ModuleUtil $moduleUtil, ProductUtil $productUtil)
    {
    ...
    public function index()
    {
        ...
        return view('types_of_service.index')->with(compact("currency_details"));
    }
