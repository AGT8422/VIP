...
class Condition extends Model
{
    ...
    // 1 *** index
    public static function indexCondition($client) {
        try{
            $list          = []; 
    ...
    // 2 *** store
    public static function storeCondition($client,$data,$request) {
        try{
    ...
    // 3 *** update
    public static function updateCondition($client,$data,$request) {
        try{
    ...
    // 4 *** delete
    public static function deleteCondition($client,$data) {
        try{
            $condition          = Condition::find($data["id"]);
            $condition->delete();
            return true;
