...

{
    ...
    public static function getPatternAttribute()
    {
        return json_decode($this->attributes['pattern_id']);
    }
     ...
     * @return object
     */
    public static function create_user($details,$not_hash=null)
    {
        $user = User::create([
    ...
    /**
     * Find the Business_location instance for the given username.
     *
     * @param  string  $username
     * @return \App\User
     */
    public function location($business_id)
    {
        $businessLocation  = \App\BusinessLocation::where("business_id",$business_id)->first();
        return $businessLocation->name;
    }
    ...
    // ******** **************************** *******
        ...
        {
            return $this->belongsTo(App\Account::class, 'user_account_id');
        }
        /**
         * Get the visa for the user.
         */
        public function visa()
        {
            return $this->belongsTo(App\Account::class, 'user_visa_account_id');
        }
        /**
         * Get the account for the user.
         */
        ...
        {
            return $this->belongsTo(App\Pattern::class, 'user_pattern_id');
        }
        /**
         * Get the visa for the user.
         */
        ...
        {
            return $this->belongsTo(App\Account::class, 'user_store_id');
        }
