...
class CreateInvoiceLayoutsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice_layouts', function (Blueprint $table) {
            ...
            $table->tinyInteger('show_commission_agent')->default(1);
            $table->tinyInteger('show_qr_code')->default(1);
            $table->text('qr_code_fields')->nullable();
            $table->string('tax_number', 191)->nullable();
            $table->string('tax_number2', 191)->nullable();
            ...
            $table->text('purchase_footer')->nullable();
            $table->timestamps();
        });
    }
