...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Currency::insert([
            ...
            [ "country" => "United Arab Emirates", "currency" => "United Arab Emirates dirham", "code" => "AED", "symbol" => "AED", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
