$(document).ready( function(){
    ...
    $(document).on('change', '#product_list_filter_image,#product_available,#sub_category_id,#product_list_filter_current_stock,#product_list_filter_current_stock,#product_list_filter_type, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id',
        function() {
            $('#offset').val(0);
            $('#morebtn').html('See More ++');
            $('#rem').val('true');
