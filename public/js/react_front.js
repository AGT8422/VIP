$(document).ready(function() {
    ...
    var react_table_app = $("#react_table_app").DataTable({
       processing:     true,
       serverSide:     true,
       scrollY:      "75vh",
       scrollX:        true,
       ...
       fnDrawCallback: function(oSettings) {
           __currency_convert_recursively($('#react_table_app'));
       },
...
//    pos_index_table.ajax.reload();
   ...
   $('table#react_table_app tbody').on('click', 'a.delete-mobile', function(e) {
       e.preventDefault();
       swal({
           title: LANG.sure,
           icon: 'warning',
