$(document).ready(function() {
    ...
    var stock_report_cols = [
            ...
            { data: 'total_recieve', name: 'total_recieve' },
            { data: 'total_delivered', name: 'total_recieve' },
            { data: 'reserved', name: 'reserved' },

        ];

        if ($('th.stock_price').length) {
            stock_report_cols.push({ data: 'price_one_purchase', name: 'price_one_purchase', searchable: false });
            ...
            stock_report_cols.push({ data: 'price_one_sell', name: 'price_one_sell', searchable: false, orderable: false });
            ...
            stock_report_cols.push({ data: 'profit_one_price', name: 'profit_one_price', searchable: false, orderable: false });
    ...
    stock_report_table = $('#stock_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('#stock_report_table tbody tr').css( {'cursor': 'pointer'});
            ...
            $('#footer_total_stock_price_one').html(__sum_stock($('#stock_report_table'), 'total_sold'));
            $('#footer_potential_profit_one').html(__sum_stock($('#stock_report_table'), 'profit_one_price'));

            $('#footer_stock_value_by_sale_price_one').html(__sum_stock($('#stock_report_table'), 'price_one_sell'));
            ...
            var total_stock_price_current= sum_table_col($('#stock_report_table'), 'current_stock');
            // $('#footer_total_stock').text(total_stock_price_current); 

            var total_stock_price_purchase= sum_table_col($('#stock_report_table'), 'price_one_purchase');
            $('#footer_total_stock_price_one').text(total_stock_price_purchase);

            var total_stock_price_profit= sum_table_col($('#stock_report_table'), 'profit_one_price').toFixed(2);
            $('#footer_potential_profit_one').text(total_stock_price_profit);

        //    alert(__sum_stock($('#stock_report_table'), 'current_stock'));
            var total_stock_price_sale = sum_table_col($('#stock_report_table'), 'price_one_sell');
            $('#footer_stock_value_by_sale_price_one').text(total_stock_price_sale);
        ...
        sr_sales_report = $('table#sr_sales_report').DataTable({
         ...
         ajax: {
            ...
            fnDrawCallback: function(oSettings) {
                ...
                // $('#sr_footer_sale_tax').text(
                //     sum_table_col($('#sr_sales_report'), 'total-tax')
                // ); 
                $('#sr_footer_total_tax').text(
                    sum_table_col($('#sr_sales_report'), 'tax-amount')
                );
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'unitCost', name: 'purchase_lines.unitCost' },
...
function updatePurchaseSell() {
    ...
    $('.total_sell_tax').html(loader);
    $('.total_purchase_tax').html(loader);
    $('.purchase_inc_tax').html(loader);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.total_purchase_tax').html(
                __currency_trans_from_en(data.purchase.total_purchase_tax, true)
            );
 
            $('.total_sell_tax').html(
                
                __currency_trans_from_en(data.sell.total_sell_tax, true)
            );
