...
return [
    ...
    "product_sell_day"                      =>"product sell day",
    ...
    "disable"                               => 'Disable',
    "loaction_address"                      => 'location',
    'sale_bill'                             => 'Sale Bill',
    "id"                                    => "id ",
    "unit"                                  => "Unit",
    "users"                                 => "Users",
    "activity_log"                          => "Activity Log",
    "product_purchas_day"                   => "product purchas day",
    "Purchase_receivables"                  => "Purchase receivables",
    "Sells_receivables"                     => "Sells receivables",
    ...
    'today'                                 => 'today',
    'wrong_recieve'                         => 'Wrong receipt',
    'Wrong receipt'                         => 'Wrong receipt',
    'delete_recieve_alert'                  => 'This Receipt will be deleted.',
    'a_recieve'                             => 'recieved',
    'a_delivered'                           => 'delivered',
    'delivered'                             => 'delivered',
    'recieved'                              => 'recieved',
    'cost_sells'                            => 'Price Sale',
    ...
    "repair"=>"repair ",
    'all_stock_transfers' => 'All Warehouse Transfers',
    'add_stock_transfer' => 'Add Warehouse Transfer',
    'list_stock_transfers' => 'List Warehouse Transfers',
    ...
    'barcode_label_error' => 'Unsupported Item Code id for the selected barcode type',
    ...
    'unit_cost_before_discount' => 'Unit Price <br>(Before Dis)',
    'Cost before without Tax' => 'Unit Price <br>(Before Dis) <br>  ',
    ...
    'pending' => 'Pending',
    'ordered' => 'Ordered',
    'search_product_placeholder' => 'Enter Product name / Item Code / Scan bar code',
    'fixed' => 'Fixed',
    ...
    'sku_ins' => 'Product Item Code. If blank an Item Code will be automatically generated',
   ...
   'selling_price_ins' => 'Sale Price (Only in numbers)',
   'selling_price_ins1' => 'If blank Sale price will be calculated <br>with the given Purchase Price <br>and Applicable Tax ',
   ...
   'add_edit_opening_stock' => 'View opening stock',
   ...
   'expiry' => 'Expiry',
   'database_add_success' => 'Database added successfully',
   'database_add_faild' => 'Addition failed ',
   'lot' => 'Lot',
   ...
   'Not Delivered'=> 'Not Delivered',
    ...
    "account_tree_purchase" => "Purchase's Account " ,
    "account_tree_sell" => " Sell's Account " ,
    "account_tree_purchase_return" => " Purchase's Return Account " ,
    "account_tree_sell_return" => " Sell's Return Account " ,
    "account_tree_purchase_discount" => "Earned Discount Account  " ,
    "account_tree_sell_discount" => " Discount granted  Account " ,
    "account_tree_asset" => " Asset Account " ,
    "account_tree_expense" => " Expense Account " ,
    "account_tree_Revenue" => " Revenue Account " ,
    "account_tree_Budget" => " Budget Account " ,
    "account_tree_liability" => " Liability Account " ,
    "account_tree_fixed_liability" => " Fixed Liability Account" ,
    "account_tree_fixed_asset" => " Fixed Asset Account " ,
    "account_tree_current_asset" => " Current Asset Account " ,
    "account_tree_current_liability" => " Current Liability Account " ,
   ...
   'selling_price_group' => 'Sale Price Group',
   'all_selling_price_group' => 'All Sale Price Group',
   'add_selling_price_group' => 'Add Sale Price Group',
   'edit_selling_price_group' => 'Edit Sale Price Group',
   'access_selling_price_groups' => 'Access Sale price groups',
   ...
   'default_selling_price_inc_tax' => 'Default Sale Price (Inc. Tax)',
   'variation' => 'Variation',
   'price_group' => 'Price Group',
   'group_price' => 'Group Price',
   'default_selling_price' => 'Default Sale Price',
   'price_group_help_text' => 'Sale Price Group in which you want to sell',
   ...
   'send_recieved_reminder' => 'Send Recieved Remider',
   ...
   "delivered_notification" => " Received  notification",
   'mail_host' => 'Host',
    'mail_port' => 'Port',
    ...
    'sell_return_added_success' => 'Sale return added successfully',
    ...
    'total_return_a_discount' => 'Total Return After Discount',
    ...
    'add_sell_return' => 'Add Sale Return',
    ...
    'assets_module'=>'Fixed Assets Unit',
    'something_went_wrong'=>'Sorry, something went wrong. ! ',
    'saved_succes'=>'Saved Successfully',
    'assets_archive'=>'Asset Register' ,
    'assete_module'=>'Asset Unit',
    'assets_view'=>'Assets View',
    'assets_create'=>'Assets Create',
    'assets_edit'=>'Data Edit',
    ...
    'asset_purchasedate'=>'Date Added',
    'asset_type'=>'Asset Type',
    'asset_type_consumed'=>'Consumer Asset',
    'asset_type_up'=>'Expandable Asset',
    'asset_price'=>'Purchase Price',
    'asset_consume_rate'=>'Depreciation/Increase Ratio',
    'asset_curentprice'=>'Current Price',
    'asset_changedate'=>'Date Modified',
    'asset_add'=>'Add Asset',
    'asset_status'=>'Case Of Origin ',
    ...
    'delete_asset'=>'Do you want to delete the original?',

    'assets' => 'Fixed Assets',
    'partners' => 'Fixed Assets Unit',
    'repair' => 'Repair',
    ...
    'add_as_sub_txonomy' => 'Add as sub Category',
    'add_as_sub_store' => 'Add as sub Store',
    'save_button' => 'save',
    'edit_button' => 'edit',
    "purchase_final" => "final",
    'movement_status_purchase'=> 'purchase',
    'movement_status_sells'=> 'sell',
    'add_as_main_store' => 'Add as Main Store',
    ...
    'import_sale_product_not_found' => 'Product with name :product_name or item code :item code not found in row :row',
    ...
    'product_name_or_sku_is_required' => 'Product name or Item Code is required',
    ...
    'product_cannot_be_empty_in_row' => 'Either product name or product Item Code is required in row :row',
    ...
    "Inventory_of_stores" => "Inventory of Warehouse",
    ...
    'either_product_name_or_sku_required' => 'Either product name (for single and combo only) or product item code required',
    ...
    "select_pricgroup"=>"Select Pricing Policy",
    ...
    "by_purchase_price_one" => "At the individual price to buy",
    'by_sale_price' => 'By sale price',
    'by_sale_price_one' => 'At the price of individuals for sale',
    'potential_profit' => 'Potential profit',
    'potential_profit_one' => 'Potential individual profit',
    'apply_all' => 'Apply all',
    ...
    'recieved_balance' => 'Recieved Balance',
    "recieved_balance_sell" => "التسليم المسبق",
    "need_balance_items" => " All Items ",
    "recieved_item" => "عناصر الاستلام ",
    "old_recieved" => " Old Recieved  ",
    "old_delivered" => "  Old Delivered  ",
    "recieved_item_sell" => "عناصر التسليم ",
    ...
    "store_quantities_in"=>"Store Quantities In",
    "store_quantities_out"=>"Store Quantities Out",
    'product_stock_history' => 'Product history',
    "production_purchase" => "Production Purchase (In)",
    ...
    'converted_to_quotation_successfully' => 'Converted to quotation  successfully',
    'convert_to_proforma' => 'Convert to Approved Quotation',
    'convert_to_quotation' => 'Convert to Quotation ',
    'proforma' => 'Approved Quotation',
    ...
    //.............................................
    'Purchase_price_in_local_currency' => 'Purchase Price in Local Currency',
    'Selling_price_in_local_currency' => 'Selling price in local currency ',
    'view_Stock' => 'View Stock',
    'view_Details' => 'View Details',
    'add_approve' => 'Add Approved Quotation',
    'unit' => 'Unit',
    '' => 'due',    
    //............................. 10-12-2022 
   'selling_price_Exc' => 'Unit Sale Price Exc.Vat',
   'inventory' => 'Inventory of Warehouse',
   ...
   'Create_an_inventory_period' => 'Create an inventory period',
   //............................... 23-12-2022
   "Pricing Group Translation" => "Pricing Group Translation",
   "default" => "default",
    //.................................27-12-2022
   "code"=>"Code",
   "compare_store"=>"Compare Store",
   "purchase_view"=>"Purchase View",
   "Adjusting_dead_stock"=>"Adjusting the quantity of products and dead stock",
   "Modifying_purchase"=>"Modifying compound discount values during purchase",
   "AddPaymentPurchase"=>"Add Purchase Payment",
   "EditPaymentPurchase"=>"Edit Purchase Payment",
   "DeletePaymentPurchase"=>"Delete Purchase Payment",
   "AddReturnPurchase"=>"Add return Purchase",
   "viewReturnPurchase"=>"View Return Purchase",
   "invoice"=>"invoice",
   "Available quantity"=>"Available quantity",
   "Not Available quantity"=>"Not Available ",
   "Available"=>"Available",
   "Not Available"=>"Not Available",
   "terms"=>"Quotation Terms",
   "create_terms"=>"Create Quotation Terms",
   "edit_terms"=>"Edit Quotation Terms",
   "add_terms"=>"Created Successfully",
   "update_terms"=>"Updated Successfully",
   "delete_terms"=>"Deleted Successfully",
   "MFG"=>"Manufacturing Setting",
   "Put_account" => "Put account name",
   "Put_Profit_account" => "Put Profit account name",
   "Profit_account" => "Profit account",
   "Wastage Percent" => "Wastage Percent",
   ...
   "approve_no"=>"Approved Quotation No",
   "quotation_no"=>"Quotation No",
   "draft_no"=>"Draft No",
   "account_liability"        => "Account liability",
   "account_assets"           => "Account Assets",
   "sorry_there_is_payment"   => "It Has Previous Payments",
   "sorry_there_is_recieve"   => "It Has Previous Received",
   "sorry_there_is_expenses"  => "It Has Previous Expenses",
   "sorry_there_is_payment_v" => "It Has Previous Voucher Payments",
   "sorry_there_is_delivery"  => "It Has Previous Delivery",
   "bank"                     => "Account Bank",
   "cash"                     => "Account Cash",
   "cash_and_bank"            => "Cash And Bank",
   "cash_list"                => "Cash List",
   "bank_list"                => "Bank List",
   "card_payment_model"       => "Card Payment Model",
   "Put_Store"                => "Manufuctoring Store",
   "Choose_M_Store"           => "Choose  Store",
   "Please_choose_mfg"        => "Please Choose The Manufuctoring Store",


   "sorry_there_is_movement"  => "This warehouse has previous transactions",
   "sorry_there_is_product"   => "This repository contains items",
   "sorry_is_main_store"      => "There are related repositories that must be deleted before",
 
  "sorry_there_is_movement"   => "This warehouse has previous transactions",
   "sorry_there_is_product"   => "This repository contains items",
   "sorry_is_main_store"      => "There are related repositories that must be deleted before",
 
   "sorry_there_is_device_active"=>"This User Is Logged In",
   "until_date"              => "Until Date",
   "Create_sells"            => "Create Sale",
   "log_file"                => "LOG File",
   "old_transaction"         => "Old Transaction",
   "Source"                  => "Source Item",
   "id"                      => "id",
   "state_action"            => "Type Of Movement",
   "parent_id"               => "Parent Source",
   "previous_movement"       => "Previous Movement",
   "user"                    => "User",
   "action_date"             => "Action Date",
   "mobile_app"              => "Mobile App Setting",
   "setting_report"          => "Report Setting",
   "setting_account_report"  => "Report Account Setting",
   ...
   "parent_account_expense"  => "Parent Expense Account",
   "parent_account_revenue"  => "Parent Revenue Account",
   "user_activation"         => "User Activation",
   "list_of_user"            => "List Of Users",
   "list_of_Register"        => "List Of Users Registers",
   ...
   "user_due_payment"        => "User Due Payment",
   "user_services"           => "User Services",
   "activation_date"         => "Activation Date",
   "user_username"           => "Username",
   "user_token"              => "User Token",
   "user_products"           => "Users Products",
   "count_of_user"           => "Count Of User",
   "user_password"           => "User Password",
   "user_period"             => "User Period ",
   "list_of_Request"         => "List Of User Request",
   "user_period_help_text"   => "<b>User Activation Time : </b><br><span>Here Enter The Number of Days That User Can Working On Application</span>",
   ...
   "View In Ecommerce"       => "View In Ecommerce",
   "account_number_used"     => "Failed !!.. The Account Number is Used",
   "Add as About-us"         => "Add as About-us",
   "right_amount"            => "Use Right Amount",
   "customer_account"        => "Customer Account Type",
   "supplier_account"        => "Supplier Account Type",
   "create_invoice_delivery" => "Create Separate Invoice Depending On Delivery Note",
   "create_delivery_invoice" => "Create Separate Invoice By Delivery Note",
   "create_invoice_payment"  => "Create Separate Invoice By Payments",
