...
return [
    ...
    */
    ...
    'sku' => "Unique product id or Stock Keeping Unit <br><br>Keep it blank to automatically generate item code.<br><small class='text-muted'>You can modify item code prefix in Business settings.</small>",
