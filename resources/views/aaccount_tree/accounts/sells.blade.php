@extends('layouts.app')
@section('title', __('lang_v1.account_tree_sell'))

@section('content')

<section class="content-header">
    <h1>{{ __('lang_v1.account_tree_sell') }}</h1>
    <br>
</section> 
...
<section class="content no-print">
    ...
    <div class="row">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped ajax_view warehouse" style=""  id="account_tree_sell">
                <thead>
                    <tr>
...
<script type="text/javascript">
    ...
    $(document).ready( function(){
        account_tree_purchase = $('#account_tree_sell').DataTable({
        	processing: true,
			serverSide: true,
            ajax:{ 
            "url":'/accountsTree/allsells',
            "data": function (d){
