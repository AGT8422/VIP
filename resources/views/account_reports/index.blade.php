...
@section('content')
    ...
    <div class="panel" style="">
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div onClick="viewShort()" class="short "  >
                            <div class="back_box"></div>
                            <h3></h3>
                            <div class="above_box sh_box">Show Shortcuts</div>
                            <div class="above_box hi_box hide">Hide Shortcuts</div>
                        </div>
                    </div>
                </div>
                <div>&nbsp;</div>
        <div class="row shorts hide">
