<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@lang( 'account.link_accousnt' ) - @lang( 'account.payment_ref_no' ): - {{$payment->payment_ref_no}}</h4>
    </div>
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            {!! Form::select('account_id', $accounts, $payment->account_id, ['class' => 'form-control Select2', 'required']); !!}
        </div>
    </div>
