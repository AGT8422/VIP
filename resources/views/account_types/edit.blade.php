<div class="modal-dialog" role="document">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
          ...
          {!! Form::text('code', $account_type->code, ['class' => 'form-control', 'required','placeholder' => __( 'lang_v1.code' ) ]); !!}
      </div>
      <div class="form-group">
     
        	{!! Form::label('parent_account_type_id', __( 'lang_v1.parent_account_type' ) . ':') !!}
          	{!! Form::select('parent_account_type_id', $account_type->all_accounts(), ($account_type->sub_parent_id != null )?$account_type->sub_parent_id:$account_type->parent_account_type_id, ['class' => 'form-control', 'placeholder' => __( 'messages.please_select' )]); !!}
      </div>
    </div>
