<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('TaxonomyController@store'), 'method' => 'post', 'id' =>  'category_add_Sub_form']) !!}
    ...
    <div class="modal-body">
      ...
      @if(!empty($parent_categories) && $enable_sub_category)
        <div class="form-group hide">
            <div class="checkbox">
              <label>
                 {!! Form::checkbox('add_as_sub_cat', 1, false,[ 'class' => 'toggler', 'data-toggle_id' => 'parent_cat_div' ,"checked"]); !!} @lang( 'lang_v1.add_as_sub_txonomy' )
              </label>
            </div>
        </div>
        <div class="form-group " id="parent_cat_div_1">
          {!! Form::label('parent_id', __( 'category.select_parent_category' ) . ':') !!}
          {!! Form::select('parent_id', $parent_categories, "please Select" , ['class' => 'form-control' , "id" => "parent_id" , "required"]); !!}
        </div>
      @endif
    </div>
