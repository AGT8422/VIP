                    ...
                    <div class="row">
                        <div class="col-md-8"  style="padding-right:0;">
                            <div class="input-group">
                                ...
                                {!! Form::text('sub_domain', NULL, ['class' => 'form-control','placeholder' => __('https://YourBusinessName')]); !!}  
                            </div>
                        </div>
                        <div class="col-md-4" style="padding-left:0;">
                            {!! Form::text('website', NULL, ['class' => 'form-control','readOnly' ,'style'=>'border:0px solid black !important','placeholder' => __('.izocloud.net')]); !!} 
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3" style="display: none">
            ...
            <span class="input-group-addon">
                <i class="fa fa-globe"></i>
                    ...
                    {!! Form::text('website', 'http://izocloud.com', ['class' => 'form-control','placeholder' => __('lang_v1.website')]); !!}
                </div>
            </div>
        </div>
    </div>
...
<!-- Owner Information -->
<div class="div-content" style="background:#f1f1f1;" >
    <div class="div-content-titel">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::password('password', ['class' => 'form-control',"id" => "password" ,'placeholder' => __('business.password'), 'required']); !!}
                </div>
            </div>
        </div>
        <div class="col-md-6">
...
<div class="col-md-6"  style="display: none">
    <div class="form-group">
        ...
        <span class="input-group-addon">
            ...
            {!! Form::text('country','Dubai', ['class' => 'form-control','placeholder' => __('business.country'), 'required']); !!}
        </div>
    </div>
</div>
<div class="col-md-6"  style="display: none">
    <div class="form-group">
        ...
        <span class="input-group-addon">
            ...
            {!! Form::text('state', 'Dubai', ['class' => 'form-control','placeholder' => __('business.state'), 'required']); !!}
        </div>
    </div>
</div>
<div class="col-md-6"  style="display: none">
    <div class="form-group">
        ...
        <span class="input-group-addon">
            ...
            {!! Form::text('city', 'Dubai', ['class' => 'form-control','placeholder' => __('business.city'), 'required']); !!}
        </div>
    </div>
</div>
<div class="col-md-6"  style="display: none">
