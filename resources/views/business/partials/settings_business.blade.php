<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-12">
            <div class="form-group" style="postion:relative; ;">
                {!! Form::label('currency_id', __('business.currency') . ':') !!}
                <div class="input-group "  >
                    <span class="input-group-addon">
                        <i class="fas fa-money-bill-alt"></i>
                    </span>
                    {!! Form::select('currency_id', $currencies, $business->currency_id, ['class' => 'form-control input_number ',  "style" => 'prsition: relative;width:100.00% !important; ','placeholder' => __('business.currency'), 'required']); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6 ">
            <div class="form-group">
                {!! Form::label('log_out', "Logout Users") !!}
                <div class="input-group">
                    <a class="btn btn-primery" href="{{action('General\EntriesController@log_out')}}">_('Logout')</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 ">
            <div class="form-group">
                <a href="{{action("ContactController@repeat_name")}}">Repeat name</a>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 ">
            <div class="form-group">
                <a href="{{action("ProductController@refreshAll")}}">Refresh Items</a>
            </div>
        </div>
        @endif
