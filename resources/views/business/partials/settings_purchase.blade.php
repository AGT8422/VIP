...
<div class="pos-tab-content">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('purchase_print_module', __('Purchase Print Module ') . ':') !!}
            {!! Form::select('purchase_print_module[]', $listModulesPurchase, json_decode($business->purchase_print_module), ['class' => 'form-control select2','multiple'=>true, 'style' => 'width: 100%;']); !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('return_purchase_print_module', __('Return Purchase Print Module ') . ':') !!}
            {!! Form::select('return_purchase_print_module[]', $listModulesPurchase, json_decode($business->return_purchase_print_module), ['class' => 'form-control select2','multiple'=>true, 'style' => 'width: 100%;']); !!}
        </div>
    </div>
    </div>
</div>