...
@section("title",__("lang_v1.bank_list"))

@section("content")

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('lang_v1.bank_list') </h1>
...
<section class="content">
    ...
    @component("components.widget",["title"=>__("lang_v1.bank_list")])
        <div class="row">
            <div class="col-xs-12">
                <div class="content">
                ...
                <div class="col-xs-12 col-xs-12 col-md-12 col-lg-12">
                    <div class="table">
                        <table class="table table-stripted" id="bank_list" style="width:100% !important">
                            <thead>
                                <tr>
