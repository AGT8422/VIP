<div class="modal-dialog" role="document" style="width:80%">
  <div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            @php
                                $trd = \App\Models\TransactionRecieved::where("transaction_id",$transaction->id)->first();
                                dd("S");
                                if(!empty($trd)){
                                  $id = $trd->id;
                                }else{
                            ...
                            @forelse ($DeliveredPrevious as $Recieved)
                                ...
                                <tr  @if($type != "other") style="background:#f1f1f1; width:100% !important" @else style="background:#ff5b5b; width:100% !important" @endif>
                                      ...
                                      <td>{!!strip_tags($notes_array[$Recieved->product->id])!!}</td>
                            ...
                            <tfoot>
                              @if(count($DeliveredPrevious)>0)
                                <tr class="bg-gray  font-17 footer-total" style="border:1px solid #f1f1f1;  ">
                                  ...
                                  <td colspan="2">@lang("home.total received") :{{intval($DelPrevious)}} </td>
                                  <td colspan="2">@lang("home.wrong received") : {{intval($DelWrong)}} </td>
                                </tr>
    ...
    <div class="modal-footer">
      <a href="{{\URL::to('reports/delivery/'.$id)}}" class="btn btn-primary no-print" target="_blank">@lang( 'messages.print' )</a>
