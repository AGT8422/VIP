...
<html lang="{{ session()->get('user.language', config('app.locale')) }}" dir="rtl">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="fixed-top " style="direction: ltr">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>الحل الأمثل لإدارة أعمالك</h1>
          <h2>أقوي برنامج محاسبي لإدارة جميع الأنشطة التجارية </h2>
          <div class="d-lg-flex">
            <a href="#about" class="btn-get-started scrollto">إبدأ معنا</a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row ">
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
            <div class="content">
              <div class="p-div">
                <p>أزها سوفت شركة متخصصة فى مجالات البرمجة و تركز على خدمة تطوير المواقع، برامج الأجهزة، التطبيقات المكتبية، التجارة الألكترونية، أنظمة المؤسسات  و الأستشارات البرمجية. و خدماتنا تتنوع بحسب العملاء و التى تأخذ فى الأعتبار أحتياجات العمل الخاصة و العامة  </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-xl-3 col-md-12 info-col info-col-1">
              ...
              <div class="info-box-text">
                <p>لا شك في ان التصميم اهم مايجذب العملاء لذلك نقدم خدمة تصميم احترافية</p>
              </div>
            </div>
            <div class="col-lg-6 col-xl-3 col-md-12 info-col info-col-2">
              <div class="img-titel">
                <img src="img/support.png" class="section-content-image" style="max-width: 150px" >
              </div>
              ...
              <div class="info-box-text">
                <p>عندما يكون لك موقع هذا افضل ما يعبر عنك ويشرح خدماتك واافكارك او ما تقدمة بشكل عام</p>
              </div>
            </div>
            <div class="col-lg-6 col-xl-3 col-md-12 info-col info-col-3  ">
              <div class="img-titel">
                <img src="img/maintenanc.png" class="section-content-image" style="max-width: 150px" >
              </div>

              <div class="col-titel ">
                <p>صيانة وتركيب الشبكات</p>
              </div>

              <div class="info-box-text">
                <p>لا تخلو اي مؤسسة من جود شبكة داخلية لدينا مهندسين محترفيين لتركيب وصيانة الشبكات</p>
              </div>
            </div>


            <div class="col-lg-6 col-xl-3 col-md-12 info-col info-col-4">
              <div class="img-titel">
                <img src="img/support.jpg" class="section-content-image" style="max-width: 150px" >
              </div>

              <div class="col-titel ">
                <p> البرمجة والدعم الفني</p>
              </div>

              <div class="info-box-text">
                <p>تصميم وإنشاء برامج حسب الطلب . تقديم الدعم الفني للتعديل و التطوير لبرامج سطح المكتب</p>
              </div>
            </div>
          </div>
