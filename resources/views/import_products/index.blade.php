...
<section class="content-header">
    <h1><b>@lang('product.import_products')</b>
    </h1>
               
    <h5><i><b>{{ "   Products  >  " }} </b>{{ "Import Products"   }} <b> {{"   "}} </b></i></h5>  
    <br> 
</section>
            ...
            <div class="row" >
                <div class="col-sm-12">
                    ...
                    <div class="row pull-left" style="width:50%">
                        <div class="col-sm-8  ">
                            @component('components.widget', ['class' => 'box-secoundry'])
                                {!! Form::open(['url' => action('ImportProductsController@store'), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                                    <div class="row" >
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    {!! Form::label('name', __( 'product.file_to_import' ) . ':') !!}
                                                    {!! Form::file('products_csv', ['accept'=> '.xls, .xlsx, .csv', "id" => "import_products",'required' => 'required']); !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-4"style="width:100%; " >
                                                <div class="col-sm-12" >
                                                        <button type="submit" class=" pull-right btn btn-primary">@lang('messages.submit')</button><a href="{{ asset('files/import_products_csv_template.xls') }}"   class="btn btn-info" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                                                </div>
                                            </div>
