      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('invoice_text', __('invoice.invoice_text') . ':' ) !!}
              {!! Form::textarea('invoice_text',"", ['class' => 'form-control',
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('purchase_text', __('invoice.purchase_text') . ':' ) !!}
              {!! Form::textarea('purchase_text',"", ['class' => 'form-control',
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('purchase_footer', __('invoice.purchase_footer') . ':' ) !!}
              {!! Form::textarea('purchase_footer' ,"", ['class' => 'form-control',
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            {!! Form::textarea('delivery_text','', ['class' => 'form-control',
        ...
        {{-- <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('quotation_terms', __('home.Quotation Terms') . ':' ) !!}
              {!! Form::textarea('quotation_terms', '', ['class' => 'form-control',
        ...
        <div class="col-sm-12">
          <div class="form-group">
              ...
              {!! Form::select('quotation_terms_id', $terms, null, ['class' => 'form-control select2' ,'id'=>'quotation_terms_id']); !!}
          </div>
        </div>
