  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('invoice_text', __('invoice.invoice_text') . ':' ) !!}
              {!! Form::textarea('invoice_text', $invoice_layout->invoice_text, ['class' => 'form-control',
              'placeholder' => __('invoice.invoice_text'), 'rows' => 3]); !!}
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('purchase_text', __('invoice.purchase_text') . ':' ) !!}
              {!! Form::textarea('purchase_text', $invoice_layout->purchase_text, ['class' => 'form-control',
              'placeholder' => __('invoice.purchase_text'), 'rows' => 3]); !!}
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('purchase_footer', __('invoice.purchase_footer') . ':' ) !!}
              {!! Form::textarea('purchase_footer', $invoice_layout->purchase_footer, ['class' => 'form-control',
              'placeholder' => __('invoice.purchase_footer'), 'rows' => 3]); !!}
          </div>
        </div>
        {{-- <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('quotation_terms', __('home.Quotation Terms') . ':' ) !!}
              {!! Form::textarea('quotation_terms', $invoice_layout->quotation_terms, ['class' => 'form-control',
              'placeholder' => __('home.Quotation Terms'), 'rows' => 3]); !!}
          </div>
        </div> --}}
        <div class="col-sm-12">
          <div class="form-group">
              {!! Form::label('quotation_terms_id', __('home.Quotation Terms') . ':*') !!}
              {!! Form::select('quotation_terms_id', $terms , $invoice_layout->quotation_terms_id, ['class' => 'form-control select2' ,'id'=>'quotation_terms_id']); !!}
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('delivery_text', __('invoice.delivery_text') . ':' ) !!}
            {!! Form::textarea('delivery_text',$invoice_layout->delivery_text, ['class' => 'form-control',
              'placeholder' => __('invoice.delivery_text'), 'rows' => 3]); !!}
          </div>
        </div>
