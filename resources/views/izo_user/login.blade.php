...
@php 
    $align_right_password= in_array(session()->get('lang', config('app.locale')), config('constants.langs_rtl')) ? 'initial' : '20px';
    $align_left_password = in_array(session()->get('lang', config('app.locale')), config('constants.langs_rtl')) ? '20px' : 'initial';
    ...
    @section('app_css')
        <style>
                ...
                .toggle-password {
                    position: absolute;
                    top: 60px;
                    right: {{$align_right_password}};
                    left: {{$align_left_password}};
                    z-index:10000;
