                ...
                <tr>
                   ...
                   <td style="width: 50%;text-align:center;color:#fff;text-align:center;padding-right:30px">
                    ...
                    <td style=" width:40%;line-height:20px;font-size:16px;">
                             <h1 style="text-transform: capitalize;margin-bottom:15px;line-height:30px">
        ...
        <table class="table" style="width:100%;margin-top: 30px;text-align:left;border: 1px solid;"  dir="ltr" >
            <thead>
                ...
                <tr>
                    ...
                    <th style="font-size:12px;font-weight: bold;background-color:#000;color:#fff">Unit Price</th> 
                    <th style="font-size:12px;font-weight: bold;background-color:#000;color:#fff">Total	</th> 
            ...
            <tbody>
                ...
                @foreach ($invoice->purchase_lines as $data)
                        ...
                        ?>
                        <tr>
                            <td style="font-size:16px;">{{ $data->product->sku }}</td>
                            <td style="font-size:16px;">
                                @if($data->product->image_url)
                                 <img src="{{ URL::to($data->product->image_url) }}" style="max-width: 120px"> 
                                @endif
                            </td>
                            <td style="font-size:16px;">{{ $data->product->name }}</td>
                            <td style="font-size:16px;">{!! $data->purchase_note !!}</td>
                            <td style="font-size:16px;">{{ $data->quantity }}</td>
                            <td style="font-size:16px;">{{  $data->purchase_price}} </td>
                            <td style="font-size:16px;"> {{ number_format($data->purchase_price*$data->quantity,4) }}</td>
        ...
        <table class="table" style="width:100%;margin-top: 10px;font-size:11px; font-weight:bold"  dir="ltr"    dir="ltr" >
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <td>
                        Total:  AED   {{ number_format($invoice->total_before_tax , 4)}} 
                    </td>
                </tr>
