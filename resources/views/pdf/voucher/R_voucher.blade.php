...
<head>
    ...
    <title>@lang("home.Receipt voucher")</title>
...
<body>
    ...
    <div class="bill"  >
        ...
        <div class="title_voucher">
            <b> @lang("home.Receipt voucher")</b> <br>
        ...
        @php  if(!empty($payment))  { $trans  = \App\Transaction::where("id",$payment->transaction_id)->first(); }   @endphp
            ...
            <div style="font-size: 12px;">
                &nbsp;&nbsp;&nbsp;&nbsp;<b>- Customer Name :</b> <span>{{$name}}</span> <br>
            ...
            <div class="row   final " style="text-align: right">
                ...
                $pr_amount  =  \App\AccountTransaction::whereHas('transaction',function($query) use( $invoice){
                                        ...
                                        ->sum("amount");
                $pr_amount2  =  \App\AccountTransaction::where('transaction_id')->whereHas('account',function($query) use( $invoice){
                                                $query->where('contact_id',$invoice->contact->id);
                                        })->where('type','credit')->where("note","!=","refund Collect")
                                        ->sum("amount");
                ...
                $diff       =   $pr_payed - $pr_amount - $pr_amount2;
                if($diff == 0){
                    $price= ($diff)  ;
                    $type= " "  ;
                }else if($diff < 0 ){
             ...
             <div style="border-bottom:2px solid #b72c0a">&nbsp;</div>
            <div>&nbsp;</div>
