...
<tr class="variation_row">
    <td>
        {!! Form::select('product_variation[' . $row_index .'][variation_template_id]', $variation_templates, null, ['class' => 'form-control input-sm variation_template','data-ks'=>0, 'required']); !!}
    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            <tr>
                ...
                <th><button type="button" data-ks='0' data-type="create" class="btn btn-success btn-xs add_variation_value_row">+</button></th>
            </tr>
            </thead>

            <tbody>
                <tr class="row_variable_for_index">
                    <td>
                    ...
                    <td>
                        <button type="button" data-ks="0"  data-variation_index="{{$row_index}}"  data-value_index="0" class="btn btn-danger btn-xs remove_variation_value_row">-</button>
                        <button type="button" data-ks="0" data-variation_index="{{$row_index}}"  data-value_index="0" class="btn btn-primary btn-xs view_list_price" style="margin-top: 10px;"><i  style="font-size: 12px">&#36;</i></button>
                        <input  type="hidden" class="variation_row_index" value="0">
                    </td>
                </tr>
                
                @include('product.partials.variable_list_price',[ "variation_index" => $row_index , "value_index" => 0 ,'ks' => $ks ,'units_main' => $units_main , 'other_unit' => $other_unit ,'name' => $name ])
            </tbody>
        </table>
    </td>
</tr>
