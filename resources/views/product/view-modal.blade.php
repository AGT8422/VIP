	...
	<div class="modal-content">
		<div class="modal-header">
		    <button type="button" class="close no-print" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		      <a  target="_blank" href="/item-move/{{$product->id}}"><h4 class="modal-title" id="modalTitle">{{$product->name}}</h4></a>
	    </div>
	    <div class="modal-body">
      		<div class="row">
      			...
      			<div class="col-sm-3 col-md-3 invoice-col">
                    ...
                    @endforeach
                    <video controls width="170" height="70">
                    ...
                    @endif<br>
					@foreach($product->variations as $i)
    					@foreach($i->media as $media)
      		...
      		@if($product->type == 'single')
      			@include('product.partials.single_product_details',["basic"=>"basic"])
