  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6 col-xs-6">
            @php
             $tr = \App\Transaction::where("return_parent_id",$purchase->id)->first(); 
            @endphp

          <a href="{{$tr->document_path}}" 
            download="{{$tr->document_name}}" class="btn btn-sm btn-success pull-left no-print">
