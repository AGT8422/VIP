...
@section("title",__("React FrontEnd Section"))

@section('content')
 

    <section class="content-header">
            <h3 class="content-header  no-print">@lang("React FrontEnd Section") </h3>
    </section>
 <section class="content-header  no-print">
    ...
    <section class="content  no-print"> 
        ...
        {{-- @can('purchase.create') --}}
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-block btn-primary" href="{{action('ReactFrontController@createApi')}}">
                    <i class="fa fa-plus"></i> @lang('messages.add')</a>
                </div>
            @endslot
        {{-- @endcan --}}
        <table class="table table-bordered  table-striped ajax_view" id="react_table_app" style="width: 100%;">
            <thead>
                <tr>
