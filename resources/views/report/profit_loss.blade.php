            ...
            <div class="form-group pull-right">
                ...
                <div class="row no-print">
                    <div class="form-group pull-right">
                        <div class="input-group">
                            <span>
                            <i class="fa fa-calendar"></i> {{ __('lang_v1.until_date') }}
                            </span>
                            <input type="date" class="form-control" name="until_date" value="{{date('Y-m-d')}}" id="until_date">
    ...
    $(document).ready( function() {
        ...
        profit_by_products_table = $('#profit_by_products_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function ( d ) {
                        ...
                        d.until_date = $('#until_date').val().format('YYYY-MM-DD');
                    }
                },
                columns: [
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            if ( target == '#profit_by_categories') {
                ...
                var url = '/reports/get-profit/day?start_date=' + start_date + '&end_date=' + end_date+ '&until_date=' + until_date;
                $.ajax({
                        url: url,
                        dataType: 'html',
