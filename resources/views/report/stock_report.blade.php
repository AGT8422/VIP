...
<div class="modal fade" id="view_stock_modal" tabindex="-1" role="dialog"
    aria-labelledby="gridSystemModalLabel">
    
</div>
<div class="modal fade" id="view_stock_modal_details" tabindex="-1" role="dialog"
    aria-labelledby="gridSystemModalLabel">
...
@section('javascript')
    ...
    <script>
        $(document).ready( function(){
            $("#stock_report_table").on('click', 'tbody tr',
            function( ){
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            __currency_convert_recursively($('#view_stock_modal'));
                        },
                    });
                });
            });
            $("#stock_report_table").on('click', 'tbody tr #view_s',
                function(){
                    $('#view_stock_modal')
                                .html(result)
                                .modal('hide');
                });
            $("#stock_report_table").on('click', 'tbody tr #view_ss',
                function(){
                    $('#view_stock_modal_details')
                                .html(result)
                                .modal('hide');
                });
