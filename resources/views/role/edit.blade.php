    ...
    <section class="content font_text">
        @component('components.widget', ['class' => 'box-primary font_text'])
            ...
            <div class="row check_group ">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.SideBar Permission' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">  
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-4"><!-- ** 13 ** -->
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'sidBar.ImportProduct', in_array('sidBar.ImportProduct', $role_permissions),
                                [ 'class' => 'input-icheck']); !!} {{ __( 'role.ImportProduct' ) }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4"><!-- ** 106 ** -->
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'sidBar.logWarranties', in_array('sidBar.logWarranties', $role_permissions),
            ...
            {{-- admin supervisor --}}
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.admin supervisor' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.admin without' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.ReadOnly' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.supervisor' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.Accountant' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.sales' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.warehouse' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.manufacturing' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.user' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'user.roles' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.supplier' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.customer' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'business.product' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            @if(in_array('purchases', $enabled_modules) || in_array('stock_adjustment', $enabled_modules) )
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">@lang( 'role.purchase' )</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                ...
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">{{__('role.stock_transfer')}} </h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}  {{__('role.view_stock_transfer')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{ __('role.request_create_stock_transfer') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{ __('role.sure_request_stock_transfer') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{ __('role.delivery_request_stock_transfer') }}
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{ __('role.received_request_stock_transfer') }}
                                </label>
                            </div>
                        </div>
                ...
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">{{ __('role.inventory_stock') }}</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_inventory_stock')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.current_value_stock')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.create_stock')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.change_status_stock')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.product_inventory')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}  {{__('role.delete_from_stock')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'sale.sale' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!} {{__('role.can_print')}}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!}    {{__('role.make_draft')}}  
                            </label>
                        </div>
                    </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}      {{__('role.edit_complixed_discount')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}   {{__('role.make_quotation')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}   {{__('role.stop_salling')}}  
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_stop_salling')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}    {{ __('role.debit_sell') }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}     {{__('role.pay_card')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}     {{__('role.many_payment')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}     {{__('role.pay_cash')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}     {{__('role.selling_less_than_purchase_price')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_list_of_sales')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_stock_in_pos')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_purchase_price_in_pos')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_daily_total')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.all_installment')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{ __( 'role.sells_return' ) }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}    {{__('role.last_sales_in_pos')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}    {{__('role.customer_balance_in_pos')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}    {{__('role.lite_pos')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}    {{__('role.repair_pos')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.all_sales_prices')}}
                                </label>
                            </div>
                        </div>
                </div>
            ...
            <div class="row check_group hide">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.expenses' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'expense.categories', in_array('expense.categories', $role_permissions),
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'cash_register.cash_register' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!}   {{__('role.show_payment_details')}}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!}     {{__('role.show_product_details')}}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.brand' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.tax_rate' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.unit' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'category.category' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.report' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!} {{__('role.report_lose')}}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!} {{__('role.report_shift')}}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!} {{__('role.product_not_used')}}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!} {{__('role.report_category_movement')}}
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                <div class="col-md-2">
                    <h4 class="font_text">@lang( 'role.settings' )</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label class="ch_all">
            ...
            <div class="row check_group">
                <div class="col-md-3">
                    <h4 class="font_text">@lang( 'role.dashboard' )</h4>
                </div>
                <div class="col-md-9">
                    <div class="col-md-4">
                        <div class="checkbox">
            ...
            <div class="row check_group">
                <div class="col-md-3">
                    <h4 class="font_text">@lang( 'izo.status_view' )</h4>
                </div>
                <div class="col-md-9">
                    <div class="col-md-4">
                        <div class="checkbox">
            ...
            <div class="row check_group">
                <div class="col-md-4">
                    <h4 class="font_text">@lang( 'account.account' )</h4>
                </div>
                <div class="col-md-8">
                    <div class="col-md-4">
                        <div class="checkbox">
                ...
                @if(in_array('booking', $enabled_modules))
                    <div class="row check_group">
                        <div class="col-md-2">
                            <h4 class="font_text">@lang( 'restaurant.bookings' )</h4>
                        </div>
                        <div class="col-md-2">
                            <div class="checkbox">
                                <label class="ch_all">
                ...
                <div class="row check_group">
                    <div class="col-md-4">
                        <h4 class="font_text"> {{__('role.Projects Setting')}} </h4>
                    </div>
                    <div class="col-md-8">
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_projects')}}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row check_group">
                    <div class="col-md-4">
                        <h4 class="font_text">{{__('role.module_catalog')}}</h4>
                    </div>
                    <div class="col-md-8">
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.show_cataloge')}}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row check_group">
                    <div class="col-md-4">
                        <h4 class="font_text"> {{__('role.module_repair')}} </h4>
                    </div>
                    <div class="col-md-8">
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}  {{__('role.setting')}}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!} {{__('role.create_version_device')}}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row check_group">
                    <div class="col-md-4">
                        <h4 class="font_text"> {{__('role.hrm_setting')}} </h4>
                    </div>
                    <div class="col-md-8">
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    ...
                                    [ 'class' => 'input-icheck']); !!}  {{__('role.hrm')}}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                @if(in_array('tables', $enabled_modules))
                    <div class="row check_group">
                        <div class="col-md-4">
                            <h4 class="font_text">@lang( 'restaurant.restaurant' )</h4>
                        </div>
                        <div class="col-md-8">
                            <div class="col-md-4">
                                <div class="checkbox">
                ...
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">@lang( 'role.Banks' )</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                ...
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">@lang( 'home.Cheques' )</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                ...
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">@lang( 'home.Voucher' )</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                ...
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">@lang( 'role.Warehouses' )</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                ...
                <div class="row check_group">
                    <div class="col-md-2">
                        <h4 class="font_text">@lang( 'role.Accounts' )</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label class="ch_all">
                ...
                {{-- Sales Price Group --}}
                <div class="row check_group hidden">
                    <div class="col-md-4">
                        <h4 class="font_text">@lang( 'lang_v1.access_selling_price_groups' )</h4>
                    </div>
                    <div class="col-md-8">
                        <div class="col-md-4">
                            <div class="checkbox">
