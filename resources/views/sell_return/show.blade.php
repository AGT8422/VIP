    ...
    <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
      <table class="table">
        <tr>
          ...
          <td></td>
            @php
                $taxes = ($sell_line->transaction->tax)?$sell_line->transaction->tax->amount:0; 
            @endphp
          <td><span class="display_currency pull-right" data-currency_symbol="true">{{ ( $total_before_tax * 100 ) / ( 100 + $taxes) }}</span></td>
        </tr>
