...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' =>  __("lang_v1.Inventories")])
        ...
        @can('stocktacking.view')
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="_table">
                    <thead>
                        <tr>
                            <th>@lang("lang_v1.Operation_Number")</th>
                            <th>@lang("lang_v1.Date")</th>
                            <th>@lang("lang_v1.Closing_Date")</th>
                            <th>@lang("lang_v1.Status")</th>
                            <th>@lang("lang_v1.Branch_Name")</th>
