<div class="modal-dialog" role="document" style="width:90%;font-size:medium">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text("amount",  $payment_line->amount , ['class' => 'form-control input_number', 'required', 'placeholder' => 'Amount']); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('paid_on', @format_datetime($payment_line->paid_on), ['class' => 'form-control',   'required']); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
