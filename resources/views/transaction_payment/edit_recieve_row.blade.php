<div class="modal-dialog" role="document" style="width:90%">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('TransactionPaymentController@update_recieve', [$payment_line->id]), 'method' => 'put', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@lang( 'purchase.edit_recieve' )</h4>
    </div>
