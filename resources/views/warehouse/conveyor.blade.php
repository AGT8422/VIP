...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid hide'   ])
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								<div class="input-group">
									...
									{!! Form::select('price_group', $price_groups, null, ['class' => 'form-control select2', 'id' => 'price_group','placeholder'=>__('lang_v1.select_pricgroup')]); !!}
									<span class="input-group-addon">
				...
				@endif
				<div class="@if(!empty($commission_agent)) col-sm-12 @else col-md-6 @endif">
					<div class="form-group">
				...
				@else
					<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-3 @endif">
						<div class="form-group">
							...
							{!! Form::select('status', [  'Delivered' => __('sale.delivery_s'),'final' => __('sale.final'),'proforma' => __('lang_v1.proforma'),'quotation' => __('lang_v1.quotation'), 'draft' => __('sale.draft')], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
						</div>
					</div>
				@endif
				<div class="col-sm-6">
			    ...
			    <div class="col-md-4">
			    	<div class="form-group">
			            ...
			            <div class="input-group">
			                ...
			                {!! Form::select('tax_rate_id', $taxes['tax_rates'], $tax, ['placeholder' => __('messages.please_select'), 'class' => 'form-control', 'data-default'=> $business_details->default_sales_tax], $taxes['attributes']); !!}
		    ...
		    <div class="col-md-4 col-md-offset-8">
				...
				@endif
		    	<div style="font-size:large"><b>@lang('sale.total_payable'): </b>
	...
	<div class="row">
		...
		<div class="col-sm-12    @if(session()->get('user.language', config('app.locale'))=='ar') text-right @else text-left  @endif ">
