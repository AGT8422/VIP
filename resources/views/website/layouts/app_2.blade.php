...
<head>
    ...
    <meta name="description" content="AZHA ERP website">
    <link rel="stylesheet" type="text/css" href="{{ asset('website/styles/bootstrap4/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('website/plugins/font-awesome-4.7.0/css/font-awesome.min.css')}}" >
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('website/styles/style.css')}}">
</head>
...
<div class="super_container">
    ...
    <div class="main_slider" style="background-image:url('{{asset('uploads/slider/slider_1.jpg')}}">
    ...
    <div class="banner">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="banner_item align-items-center" style="background-image:url('{{asset('uploads/slider/banner_1.jpg')}}">
